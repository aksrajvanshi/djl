...
![Proxy Settings Firefox](https://github.com/aws-samples/djl-demo/raw/master/malicious-url-detector/docs/proxy_firefox.png)

Now you can try to navigate to a mispelled amazon.com URL in the browser navigator and see the proxy at work.

![Oops Malicious URL](https://github.com/aws-samples/djl-demo/blob/master/malicious-url-detector/docs/wrong_url_firefox.png?raw=true)
...
![Benign Website](https://github.com/aws-samples/djl-demo/raw/master/malicious-url-detector/docs/correct_firefox.png)    
